...
const defaultFaqItems: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      'The California-mandated traffic school online course is 6 hours long. However, since our course is self-paced, you can complete it over multiple sessions and take as much time as you need. Most students finish within a few days to a week.',
  },
  {
    id: 'when-receive-certificate',
    question: 'When will I receive my completion certificate?',
    answer:
      'Upon successful completion of the course and final exam, your completion certificate is available for immediate download. We electronically report your completion to the court, and the court then forwards this information to the DMV, typically within 1-2 business days.',
  },
  {
    id: 'what-if-fail',
  ...
  },
  {
    ...
    answer:
      'We offer 6-12 AM customer support via phone and email. Our friendly support team is ready to help you with any questions or technical issues you may encounter during your course.',
  },
];
...
export const TrafficSchoolFaq = ({
  ...
  return (
    <StandardFaq
      ...
      ctaDescription="Our friendly customer support team is here to help you 6-12 AM. Get started with your traffic school course today!"
      primaryCta={{
